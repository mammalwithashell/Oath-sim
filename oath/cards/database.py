...
_register(CardData(card_id=2, name="Taming Charm", suit=Suit.ARCANE, restriction=CardRestriction.NONE, oath_id="OATH-037"))
_register(CardData(card_id=3, name="Elders", suit=Suit.NOMAD, restriction=CardRestriction.ADVISER_ONLY, oath_id="OATH-026"))
_register(CardData(card_id=4, name="Forest Paths", suit=Suit.BEAST, restriction=CardRestriction.ADVISER_ONLY, oath_id="OATH-043"))
...
_register(CardData(card_id=7, name="A Small Favor", suit=Suit.DISCORD, restriction=CardRestriction.NONE, oath_id="OATH-015"))
_register(CardData(card_id=8, name="Garrison", suit=Suit.ORDER, restriction=CardRestriction.SITE_ONLY, oath_id="OATH-007"))
_register(CardData(card_id=9, name="Errand Boy", suit=Suit.BEAST, restriction=CardRestriction.NONE, oath_id="OATH-011"))
...
_register(CardData(card_id=12, name="Scryer", suit=Suit.DISCORD, restriction=CardRestriction.ADVISER_ONLY, oath_id="OATH-019"))
_register(CardData(card_id=13, name="Bear Traps", suit=Suit.ORDER, restriction=CardRestriction.SITE_ONLY, oath_id="OATH-003"))
...
_register(CardData(card_id=17, name="Wrestlers", suit=Suit.ORDER, restriction=CardRestriction.NONE, oath_id="OATH-001"))
